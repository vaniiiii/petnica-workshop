...
import {IStreamingContractV2} from "./IStreamingContractV2.sol";
import {IERC20} from "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import {SafeERC20} from "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";

/// @title StreamingContractV2
/// @notice Implementation of ETH and ERC20 token streaming with cancellation
/// @dev Extends V1 with token support and ability to cancel streams
contract StreamingContractV2 is IStreamingContractV2 {
    ...
    /// @inheritdoc IStreamingContractV2
    ...
    function withdrawFromStream(uint256 streamId) external {
        ...
        _transfer(stream.tokenAddress, stream.recipient, withdrawableAmount);
